...
|	| Initiate a tournament, and the tournament should offer a matchmaking system to connect local players. | ✅|✅|4 players tournamnt works
...
|	| when game over, there is a end-game screen |✅|✅| always showing "🏁 Game over!
...
|**User Management modules**|**Major (1): Standard user management and authentication.**|❌|❌| on settings page: profile pic update works, name update works, update password NOT working,
|	| **Minor(0.5): Game statistics and match history** |✅|✅| number of wins, number of losses, number of trophies works, match history table works
...
|**AI-Algo**| **Minor module (0.5): User and game stats dashboards** |✅|✅|pie chart visible and correct according to the data, 2 bar charts visible, 2 tables visible, sorting on table header of ranking table by click on header cell
...
**More Issues:**
- after changing profile pic, nav bar is not showing, I can not leave the profile page, I can not play the game -> refresh the page make the nav bar appearing again ✅issue fixed
- after registering a new user, nav bar is not showing, I can not leave the profile page, I can not play the game -> refresh the page make the nav bar appearing again ✅issue fixed
- move QR Code in sign up into the middle of the card, atm it is left
- language dropdown on local tournament game not working