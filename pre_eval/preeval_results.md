 ...
 **Cybersecurity modules** | **major module (1): Two-Factor Authentication (2FA) and  JSON Web Tokens (JWT)** ||| 2FA: additional layer of security  with secondary verification method with "Google authenticator smartphone app"<br>Login works. But logout and login again says "Error", user entry visible in database
