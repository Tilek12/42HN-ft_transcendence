					...
					<div>
						...
						<span class="${is_connected ? 'text-green-600' : 'text-gray-500'}">
							...
							<button 
								...
								class="answer-request-btn px-16 py-2 bg-green-600 hover:bg-green-700 text-white rounded">
								✔
							</button>
							<button
								data-profile-answer="decline" 
								data-profile-id="${profile.id}"
								class="answer-request-btn px-16 py-2 bg-red-600 hover:bg-red-700 text-white rounded">
								✖
							</button>
					</div>
