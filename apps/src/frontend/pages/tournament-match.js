...
exports.renderTournamentMatch = renderTournamentMatch;
const nav_1 = require("./nav");
const layout_1 = require("../utils/layout");
const ws_manager_1 = require("../websocket/ws-manager");
function renderTournamentMatch(root) {
  ...
  `);
    ...
    const socket = ws_manager_1.wsManager.createGameSocket('tournament');
    let gameState = null;
    let moveInterval;
    ...
    function draw() {
        ...
        if (gameState) {
            ...
            for (const [id, y] of Object.entries(gameState.paddles)) {
                ...
                ctx.fillRect(x, y * scaleY, 10, 20 * scaleY);
            }
        }
...
//# sourceMappingURL=tournament-match.js.map