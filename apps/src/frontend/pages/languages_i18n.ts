import { TranslationSet } from '../frontendTypes.js'
...
export const translations_profile: TranslationSet =
{
	EN: {
		...
		no_friend_requests: 'No Friend Requests currently...',
		no_friends: 'No Friends currently...',
	...
	DE: {
		...
		no_friends: 'Keine Freunde momentan...',
		no_users: 'Keine anderen Nutzer...',
	...
	GR: {
		...
		no_match_history: 'Δεν υπάρχει ιστορικό αγώνων ακόμα...',
		no_friend_requests: 'Δεν υπάρχουν αιτήματα φιλίας προς το παρόν...',
		no_friends: 'Δεν υπάρχουν φίλοι προς το παρόν...',
		no_users: 'Δεν υπάρχουν άλλοι χρήστες...',
...
export const translations_settings: TranslationSet =
{
	EN: {
		...
		no_picture:'Already Default Picture',
		update: 'Update',
		delete: 'Delete',
		edit: 'Edit',
		cancel: 'Cancel',
	...
	DE: {
		...
		no_picture:'Bereits Standard Bild',
	...
	GR: {
		...
		no_picture:'Ήδη προεπιλεγμένη εικόνα',
		update: 'Ενημέρωση',
		delete: 'Διαγραφή',
		edit: 'Επεξεργασία',
		cancel: 'Ακύρωση',
