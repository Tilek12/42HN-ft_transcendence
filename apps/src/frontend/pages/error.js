...
exports.renderConnectionErrorPage = renderConnectionErrorPage;
const layout_js_1 = require("../utils/layout.js");
function renderConnectionErrorPage() {
    const root = document.getElementById('app');
    if (root)
        root.innerHTML = (0, layout_js_1.renderBackgroundFull)(
        /*html*/ `
