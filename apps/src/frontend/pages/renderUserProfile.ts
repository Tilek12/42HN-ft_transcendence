...
export function renderUserProfile(backend_url: string, data: any)
{
	let res : string = renderBackgroundTop(`
		...
		<input id="password-old-check" type="password" placeholder="Current password"
			class="text-black border border-gray-300 rounded px-2 py-1 pr-8 w-64">
		...
		<p class="mt-4 space-x-2">
		<input id="password-update-one" type="password" placeholder="New password"
			class="text-black border border-gray-300 rounded px-2 py-1 pr-8 w-64">
		<button type="button" data-toggle="password-update-one" class="absolute right-2 top-1.5 text-gray-500">👁</button>
		</p>

		<p class="mt-4 space-x-2">
		<input id="password-update-two" type="password" placeholder="Confirm new password"
			class="text-black border border-gray-300 rounded px-2 py-1 pr-8 w-64">
		...
		<button id="password-update-btn" disabled class="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded">Update</button>
		<button id="password-cancel-btn" class="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded">Cancel</button>
		</div>
