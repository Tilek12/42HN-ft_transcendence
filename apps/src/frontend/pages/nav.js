...
function updateOnlineUsers() {
    const count = ws_manager_1.wsManager.onlineUserCount;
    const users = ws_manager_1.wsManager.presenceUserList;
...
function renderNav() {
    ...
    if (!presenceUnsub) {
        presenceUnsub = ws_manager_1.wsManager.subscribeToPresence(() => {
