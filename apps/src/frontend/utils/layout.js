...
exports.renderBackgroundFull = renderBackgroundFull;
exports.renderBackgroundTop = renderBackgroundTop;
function renderBackgroundFull(content) {
    return `
...
function renderBackgroundTop(content) {
    return `
	  <div class="fixed inset-0 bg-gradient-to-br from-indigo-900 via-blue-900 to-purple-900">
		<!-- Animated background elements -->
		<div class="fixed inset-0 opacity-20 pointer-events-none">
