	...
	return (
		...
		<div class="fixed bottom-8 right-8 z-50 ">
			<div class="relative">
				...
				<div id="global-lang-dropdown" class=" z-[9999] pointer-events-auto hidden absolute bottom-full right-0 mb-3 w-48 bg-gray-900/95 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl overflow-hidden">
